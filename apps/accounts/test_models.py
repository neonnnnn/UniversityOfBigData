...
class UserModelTests(TestCase):
    ...
    def test_raise_IntegrityError_if_duplicated_username(self):
        ...
        self.assertRaises(IntegrityError, User.objects.create, username="testuser")
    ...
    def test_raise_IntegrityError_if_duplicated_nickname(self):
        ...
        self.assertRaises(
            IntegrityError, User.objects.create, username="testuser2", nickname="hoge"
        )

    def test_empty_nickname_filled(self):
        """nicknameが空の場合にusernameと同じになっているか."""
        user = User.objects.create(username="testuser1", email="test1@test")
    ...
    def test_user_has_expected_permission(self):
        """通常ユーザの権限の確認."""
        user = User.objects.create_user(username="testuser", email="test@test")
